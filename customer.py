...
class Cust_Win:
    def __init__(self, root):
        ...
        lblimg4.place(x=5, y=2, width=70, height=32)
        ...
        label_gender = Label(
            DataFrameLeft, font=("arial", 12, "bold"), text="Gender:", padx=2, pady=6
        )
        label_gender.grid(row=3, column=0, sticky=W)
        comgender = ttk.Combobox(
            DataFrameLeft,
            state="readonly",
        ...
        lblPostCode = Label(
            DataFrameLeft, font=("arial", 12, "bold"), text="PostCode:", padx=2, pady=6
        )
        ...
        lblMobile = Label(
            DataFrameLeft, font=("arial", 12, "bold"), text="Mobile:", padx=2, pady=6
        )
        ...
        lblEmail = Label(
            DataFrameLeft, font=("arial", 12, "bold"), text="Email:", padx=2, pady=6
        )
        ...
        lblIdNumber = Label(
            DataFrameLeft, font=("arial", 12, "bold"), text="Id Number:", padx=2, pady=6
        )
        ...
        lblAddress = Label(
            DataFrameLeft, font=("arial", 12, "bold"), text="Address:", padx=2, pady=6
        )
        lblAddress.grid(row=10, column=0, sticky=W)
        txtAddress = ttk.Entry(
            DataFrameLeft,
            textvariable=self.var_adderss,
            font=("arial", 13, "bold"),
            width=29,
        )
        ...
        # ===========Buttonframe================================================================================
        ButtonFrame = Frame(DataFrameLeft, bd=0, relief=RIDGE)
        ...
        Table_frame = LabelFrame(
            self.root,
            text="View Customer Details & Search",
            font=("arial", 11, "bold"),
            bd=3,
            relief=RIDGE,
        )
        ...
        details_table.place(x=0, y=50, width=855, height=423)
    ...
    def add_data(self):
        if self.var_ref.get() == "" or self.var_mobile.get() == "":
            ...
            try:
                ...
                my_cursor.execute(
                    "insert into hotel values(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)",
                    (
                        self.var_ref.get(),
                ...
                conn.close()
                messagebox.showinfo(
                    "Success", "Customer has been inserted", parent=self.root
                )

            except Exception as es:
                messagebox.showerror(
                    "Error",
                    f" Must be enter Integer number, is Primery Key :{str(es)}",
                    parent=self.root,
                )
    ...
    def update_data(self):
        if self.var_ref.get() == "" or self.var_mobile.get() == "":
            ...
            my_cursor = conn.cursor()
            my_cursor.execute(
                "update hotel set  Cust_Name=%s,Mother_Name=%s,Gender=%s,PostCode=%s,Mobile=%s,Email=%s,Nationality=%s,Id_Proof=%s,Id_Number=%s,Address=%s where Ref=%s",
                (
                    self.var_cust_name.get(),
                    self.var_mother.get(),
                    self.var_gender.get(),
